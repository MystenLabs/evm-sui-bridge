...
# install :; forge install OpenZeppelin/openzeppelin-contracts-upgradeable@v4.8.1 && forge install OpenZeppelin/openzeppelin-contracts@v4.8.1 && forge install foundry-rs/forge-std@v1.3.0 && forge install Uniswap/v3-periphery
